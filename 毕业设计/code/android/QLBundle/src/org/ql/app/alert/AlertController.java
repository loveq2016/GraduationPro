...
public class AlertController {
	...
	public void installContent() {
		...
		mWindow.setContentView(R.layout.ql_alert_dialog);
		setupView();
	}
	...
	private void setupView() {
		...
		// =====改变内存区域背景=====//
		LinearLayout parentContent = (LinearLayout) mWindow.findViewById(R.id.parentContent);
		// parentContent.setBackgroundResource(hasTitle ?
		// R.drawable.ql_alert_dialog_content_bg :
		// R.drawable.ql_alert_dialog_content_full_bg);
		parentContent.setBackgroundResource(android.R.color.transparent);
	...
	private boolean setupTitle(LinearLayout topPanel) {
		...
		if (mCustomTitleView != null) {
			...
			if (hasTextTitle) {
				...
				mIconView.setImageResource(R.drawable.ql_alert_dialog_ic_menu_generic);
	...
	private void centerButton(Button button) {
		button.setBackgroundResource(R.drawable.ql_alert_dialog_button);
		/*
		 * LinearLayout.LayoutParams params = (LinearLayout.LayoutParams)
		 * button.getLayoutParams(); params.gravity = Gravity.CENTER_HORIZONTAL;
		 * params.weight = 0.5f; button.setLayoutParams(params); View leftSpacer
		 * = mWindow.findViewById(R.id.leftSpacer);
		 * leftSpacer.setVisibility(View.VISIBLE); View rightSpacer =
		 * mWindow.findViewById(R.id.rightSpacer);
	...
	// bak
	/*
	 * private void centerButton(Button button) { LinearLayout.LayoutParams
	 * params = (LinearLayout.LayoutParams) button.getLayoutParams();
	 * params.gravity = Gravity.CENTER_HORIZONTAL; params.weight = 0.5f;
	 * button.setLayoutParams(params); View leftSpacer =
	 * mWindow.findViewById(R.id.leftSpacer);
	 * leftSpacer.setVisibility(View.VISIBLE); View rightSpacer =
	 * mWindow.findViewById(R.id.rightSpacer);
	 * rightSpacer.setVisibility(View.VISIBLE); }
	 */
	private void setBackground(LinearLayout topPanel, LinearLayout contentPanel, View customPanel, boolean hasButtons, boolean hasTitle, View buttonPanel) {
		...
		// // int centerDark =
		// a.getResourceId(R.styleable.AlertDialog_centerDark,
		...
		// // int centerBright =
		// a.getResourceId(R.styleable.AlertDialog_centerBright,
		...
		// // int centerMedium =
		// a.getResourceId(R.styleable.AlertDialog_centerMedium,
		...
		// * to correctly use the full, top, middle, and bottom graphics
		// depending
		...
		// */
		// //lastView.setBackgroundResource(lastLight ? (hasButtons ?
		// bottomMedium : bottomBright) : bottomDark);
	...
	public static class AlertParams {
		...
		private void createListView(final AlertController dialog) {
			final RecycleListView listView = (RecycleListView) mInflater.inflate(R.layout.ql_alert_select, null);
			ListAdapter adapter;

			if (mIsMultiChoice) {
				if (mCursor == null) {
					adapter = new ArrayAdapter<CharSequence>(mContext, R.layout.ql_alert_select_multichoice, R.id.text1, mItems) {
						@Override
					...
					adapter = new CursorAdapter(mContext, mCursor, false) {
						...
						public View newView(Context context, Cursor cursor, ViewGroup parent) {
							return mInflater.inflate(R.layout.ql_alert_select_multichoice, parent, false);
						}
					};
				}
			} else {
				int layout = mIsSingleChoice ? R.layout.ql_alert_select_singlechoice : R.layout.ql_alert_select_item;
				if (mCursor == null) {
