...
/**    
* 类名称：QLIphoneAlert <br>  
* 类描述：仿iphone弹出窗口  <br>
* 创建者：anan <br>
* 创建时间：2013-1-10 上午10:05:06 <br>   
* 修改者：anan <br>    
* 修改时间：2013-1-10 上午10:05:06 <br>    
* 修改备注：  <br>
* @version    
*/   
public final class QLIphoneAlert {

	public interface OnAlertSelectId {
		void onClick(int whichButton);
	}

	private QLIphoneAlert() {
...
class AlertAdapter extends BaseAdapter {
	...
	public AlertAdapter(Context context, String title, String[] items, String exit, String cancel) {
		if (items == null || items.length == 0) {
			...
			this.items = QLStringUtils.stringsToList(items);
		}
