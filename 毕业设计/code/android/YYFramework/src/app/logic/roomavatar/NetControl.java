...
public class NetControl {
        ...
        exService.execute( new Runnable() {
            ...
            public void run() {
                ...
                if( path == null || TextUtils.isEmpty( path )){
                    Bitmap bitmap = BitmapFactory.decodeResource( mContext.getResources() , R.drawable.default_user_icon);
    ...
    private void fromNet(String path) {
        ...
        try {
            ...
            e.printStackTrace();
            bitmap = BitmapFactory.decodeResource( mContext.getResources() , R.drawable.default_user_icon);
            onNetCallBackListener.onNetCallback( bitmap );
        }
    }
