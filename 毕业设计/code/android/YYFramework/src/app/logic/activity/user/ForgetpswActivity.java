...
public class ForgetpswActivity extends ActActivity {
    ...
    private void intiTootBar() {
        ...
        if (FORGET_PSW.equals(title_str)) {  //忘記密碼
            ...
            forgetpw_phoneNum.setText(mUsername);
        }
        ...
        public void onClick(View view) {
            ...
            switch (view.getId()) {
                case R.id.forgetpw_next:
                    if (!forget_phoneNum.equals("") && forget_phoneNum.length()==11 && !forget_yzm.equals("") && !forget_newpsw.equals("") && !forget_ensure.equals("")) {
                    ...
                    } else if("".equals(forget_phoneNum) || forget_phoneNum.length()!=11){
                        Toast.makeText(ForgetpswActivity.this, "请输入有效的手机号码", Toast.LENGTH_SHORT).show();
                    }else if ("".equals(forget_yzm)){
                        Toast.makeText(ForgetpswActivity.this, "验证码不能为空", Toast.LENGTH_SHORT).show();
                    }else{
