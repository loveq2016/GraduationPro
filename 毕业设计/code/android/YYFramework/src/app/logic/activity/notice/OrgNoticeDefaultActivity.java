        ...
        unReadAdapter = new YYBaseListAdapter<NoticeInfo>(this) {
            ...
            public View createView(int position, View convertView, ViewGroup parent) {
                if (convertView == null) {
                    ...
                    saveView("org_image", R.id.org_image, convertView);
                ...
                if (info != null) {
                    ...
                    if(info.getFriend_name()!=null && !TextUtils.isEmpty( info.getFriend_name())){
                        setTextToViewText(info.getFriend_name(), "msg_user", convertView);
                    }else{
...
//                    intent.putExtra(ORG_IMAGE,orgImageUrl);
                    intent.putExtra(ORG_IMAGE,info.getPicture_url());
