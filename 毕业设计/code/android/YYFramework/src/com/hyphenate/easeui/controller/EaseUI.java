...
public final class EaseUI {
    ...
    protected EMOptions initChatOptions() {
        ...
        options.setHuaweiPushAppId("10687661");

        //you need apply & set your own id if you want to use Mi push notification
        options.setMipushConfig("2882303761517517983", "5421751746983");
    ...
    private boolean isMsgNotifyAllowed = true ;
    ...
    public boolean isMsgNotifyAllowed() {
        return isMsgNotifyAllowed;
    }

    public void setMsgNotifyAllowed(boolean msgNotifyAllowed) {
        isMsgNotifyAllowed = msgNotifyAllowed;
    }
    ...
    public void setMsgSoundAllowed(boolean msgSoundAllowed) {
        isMsgSoundAllowed = msgSoundAllowed;
    }
    ...
    public void setMsgVibrateAllowed(boolean msgVibrateAllowed) {
        isMsgVibrateAllowed = msgVibrateAllowed;
    }
    ...
    public void setSpeakerOpened(boolean speakerOpened) {
        isSpeakerOpened = speakerOpened;
    }
