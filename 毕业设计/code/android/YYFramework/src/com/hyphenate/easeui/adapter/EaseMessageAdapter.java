...
public class EaseMessageAdapter extends BaseAdapter{
	...
	private HashMap<String, UserInfo> memberList = new HashMap<>();
	...
	public void setMassageList(List<UserInfo> users,int chatType){
		this.chatType = chatType;
		memberList.clear();
		if (users != null && users.size() > 0) {
			for (UserInfo userInfo : users) {
//				memberList.put(userInfo.getPhone(), userInfo);
				memberList.put(userInfo.getWp_member_info_id(), userInfo);
			}
		}
		UserInfo currUserInfo = UserManagerController.getCurrUserInfo();
//		memberList.put(currUserInfo.getPhone(), currUserInfo);
		memberList.put(currUserInfo.getWp_member_info_id(), currUserInfo);
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		((EaseChatRow)convertView).setUpView(message,memberList,chatType, position, itemClickListener);
