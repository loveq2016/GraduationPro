...
//        });
                ...
                if (listener != null) {
                    ...
                    if (Build.VERSION.SDK_INT >= 23) {
                        if (ContextCompat.checkSelfPermission(context, android.Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions((Activity) context, new String[]{android.Manifest.permission.RECORD_AUDIO}, EaseChatFragment.REQUEST_PERMISSION_VOICE_);
                        } else {
    ...
    private void showMenu(View view) {
        if (popupWindow == null) {
            View menuView = LayoutInflater.from(context).inflate(R.layout.ease_edittext_pop_edit, null);
            popupWindow = new PopupWindow(menuView, ViewPager.LayoutParams.WRAP_CONTENT, ViewPager.LayoutParams.WRAP_CONTENT);
            menuView.findViewById(R.id.copy).setOnClickListener(new OnClickListener() {
                @Override
            ...
            menuView.findViewById(R.id.paste).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    pasteToResult();
                    if (popupWindow!=null)
            ...
            menuView.findViewById(R.id.all_select).setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    editText.selectAll();
                }
        ...
        popupWindow.update();
        popupWindow.showAsDropDown(view, 0, ((int)view.getY())- QLImageUtil.dip2px(context,70));
    ...
    private void copyFromEditText1() {
        ...
        ClipData clip = ClipData.newPlainText("simple text",editText.getText());
    ...
    private void pasteToResult() {
        ...
        if (!mClipboard.hasPrimaryClip()) {
            QLToastUtils.showToast(context,"剪贴板无数据");
        }
        else {
