...
import org.ql.utils.logger.Logger;
...
/**    
* 类名称：QLXListView    
* 类描述：实现下拉刷新上拉加载更多的超级listview  
* 创建人：anan
* 创建时间：2012-11-28 下午5:32:38    
* 修改人：anan    
* 修改时间：2012-11-28 下午5:32:38    
* 修改备注：  
* @version    
*/   
public class QLXListView extends ListView implements OnScrollListener {
	...
	public QLXListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public QLXListView(Context context, AttributeSet attrs, int defStyle) {
