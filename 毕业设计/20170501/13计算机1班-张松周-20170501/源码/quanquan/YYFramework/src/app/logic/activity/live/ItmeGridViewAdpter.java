...
public class ItmeGridViewAdpter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if( convertView == null ){
            ...
            viewHolder.orgLogoImg = (SimpleDraweeView) convertView.findViewById( R.id.org_log);
            ...
            viewHolder.orgLogoImg2 = (SimpleDraweeView) convertView.findViewById( R.id.org_log2);
...
//                Picasso.with(parent.getContext()).load(HttpConfig.getUrl(orgInfo.getOrg_logo_url())).
//                        placeholder(R.drawable.default_user_icon).error(R.drawable.default_user_icon).
//                        fit().centerCrop().into(viewHolder.orgLogoImg);
//
...
//                    Picasso.with(parent.getContext()).load(HttpConfig.getUrl(orgInfo1.getOrg_logo_url())).
//                            placeholder(R.drawable.default_user_icon).error(R.drawable.default_user_icon).
//                            fit().centerCrop().into(viewHolder.orgLogoImg2);
    ...
    class ViewHolder{
        ...
        //ImageView orgLogoImg,orgLogoImg2  ;
        View layout1,layout2;
        TextView stateView1 , stateView2 ;
        SimpleDraweeView orgLogoImg ,orgLogoImg2;
    }
