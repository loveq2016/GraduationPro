...
/**     
 * 类名称：SlidingView   <br>
 * 类描述：自定义ViewGroup，实现三个页面挤压<br>
 * 创建人：anan <br>  
 * 创建时间：2012-12-23 上午12:19:27 <br>  
 * 修改人：anan  <br>
 * 修改时间：2012-12-23 上午12:19:27 <br>  
 * 修改备注：   <br>
 * @version        
 * */
public class QLSlidingView extends ViewGroup {
	...
	public QLSlidingView(Context context) {
		super(context);
		init();
	}

	public QLSlidingView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public QLSlidingView(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP:
			if (mIsBeingDragged) {
				...
				velocityX = 0;
				QLLog.e("ad", "velocityX == " + velocityX);
