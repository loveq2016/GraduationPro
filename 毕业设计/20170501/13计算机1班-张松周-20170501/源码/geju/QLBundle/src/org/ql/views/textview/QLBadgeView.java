 ...
 * @author Jeff Gilfelt
 */
public class QLBadgeView extends TextView {
	...
	public QLBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public QLBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public QLBadgeView(Context context, View target) {
     ...
     */
	public QLBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public QLBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public QLBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
