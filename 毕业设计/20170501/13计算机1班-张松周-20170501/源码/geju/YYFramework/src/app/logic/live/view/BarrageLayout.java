...
//            builder.onStop(new Animation.AnimationListener.Stop() {
//                @Override
//                public void onStop() {
...
//            });
    ...
    private void init(Context context, AttributeSet attrs) {
       View view =  LayoutInflater.from(context).inflate(R.layout.widget_barrage_layout, this);
    ...
    private void findViewById( View view ){
        container1 = (RelativeLayout) view.findViewById( R.id.container1);
