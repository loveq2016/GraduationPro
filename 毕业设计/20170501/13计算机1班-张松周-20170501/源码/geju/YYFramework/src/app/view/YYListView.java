...
/**
*
* SiuJiYung create at 2016年6月30日 上午9:34:56
*
*/

public class YYListView extends SwipeMenuListView implements OnScrollListener {
	...
	public boolean openMenuEnable(int position){
		if (this.adapter instanceof SmoothMenuAdapter) {
			return ((SmoothMenuAdapter)adapter).menuEnable(position - 1);
		}
		return true;
	}
