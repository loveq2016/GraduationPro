...
public class YYIMService extends Service implements EMMessageListener{
    ...
    public void onCreate() {
        super.onCreate();
        setIMSettings();
        QLLog.i("====","setIMSettings=========onCreate========");
        mBR = new BroadcastReceiver() {
            @Override
            public void onReceive(Context context, Intent intent) {
                // TODO Auto-generated method stub
                Intent a = new Intent(YYIMService.this, YYIMServiceB.class);
                startService(a);
            }
        };
        IntentFilter mIF = new IntentFilter();
        mIF.addAction("listenerA");
    ...
    public void onStart(Intent intent, int startId) {
        ...
        setIMSettings();
        QLLog.i("====","setIMSettings=======onStart==========");
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        QLLog.i("====","setIMSettings=======onStartCommand==========");
...
//        return START_STICKY_COMPATIBILITY;
    ...
    public void onDestroy() {
        super.onDestroy();
        QLLog.i("====","setIMSettings=======onDestroy==========");
