...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        lp.addRule(CENTER_HORIZONTAL, TRUE);//这里的TRUE 要注意 不是true  （水平居中）
        lp.addRule(ALIGN_PARENT_BOTTOM, TRUE);                       //   （底部）

        // 初始化插补器
        interpolators = new Interpolator[4];
        interpolators[0] = line;   //线性的
        interpolators[1] = acc;    //加速
        interpolators[2] = dce;    //减速
        interpolators[3] = accdec; //先加后减
    }
